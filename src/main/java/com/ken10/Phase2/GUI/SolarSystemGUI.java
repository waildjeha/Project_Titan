...
public class SolarSystemGUI extends Application {
    ...
    private void loadEphemerisData() {
        ...
        CelestialBodies probe = new Probe("probe", new Vector(-1.4664541859104577E8, -2.8949304626334388E7, 2241.9186033698497), new Vector(62.37766685559131, -32.92234163864975, -15.852587264581345), 1.0, 11.0);
